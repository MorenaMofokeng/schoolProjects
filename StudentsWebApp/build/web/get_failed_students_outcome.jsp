...
<html>
    <head>
        ...
        <title>Get Failed Students Records Outcome Page</title>
    </head>
    <body>
        <h1>Get Failed Students Records Outcome</h1>
        <%
        ...
        %>
        <p>
            There are <b><%=cnt%></b> students who failed the test.
        ...
        %>
        <p>
            There are no students that failed the test.
        </p>
         <%
             }
        %>
